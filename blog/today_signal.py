...
每个主题输出：cluster_index、category、title、what_happened、discussion_focus（3 到 5 个，具体到观点分歧或关注点，每个 6-16 字，不要单个名词）、why_ranked、missing_angle、video_queries。title 不超过 34 个中文字符；what_happened 只说一个核心事实；why_ranked 不重复事实。
